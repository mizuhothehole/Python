...
def myship(event, ob):
    ob.delete("all")
    shipId = ob.create_rectangle(10, 10, 20, 20, fill = 'brown')

def leftmoving(event,ob,idd):
    ob.coords(idd, 200, 200, 210, 210)
...
class App(object):
	...
	#self.com3.bind("<a>", handleradaptor(clr, ob=self.com3))
        id = self.com3.create_rectangle(10, 10, 20, 20, fill = 'brown')
	self.com3.bind("<a>", handleradaptor(leftmoving, ob=self.com3,idd=id))
